...
/**
 * Servlet implementation class changegmail
 */
@WebServlet("/changegmail")
public class changegmail extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			String emp_email,emp_id;
			
		   emp_email=request.getParameter("email");
		    ...
		    st.executeUpdate();
		    response.sendRedirect("emailchanged.jsp");
		    con.close();
		}
		catch (Exception e) 
		{
